  ...
  const scenes = useMemo((): Scene[] => {
    ...
    return [
      ...
      },
      {
        id: 'agendamento',
        label: 'Agendar',
        description: 'Fluxo de agendamento — seleção por lista interativa',
        messages: [
          ...
          {
            sender: 'bot',
            text: '📅 Escolha o dia da consulta:',
          ...
          { sender: 'patient', text: 'Terça-feira, 29/04' },
          {
            sender: 'bot',
            text: '🕐 Horários disponíveis para *Terça-feira, 29/04*:',
            choices: ['09h00', '09h30', '10h00', '11h00', '14h00', '14h30', '15h00', '16h00', '↩️ Outra data'],
          },
          { sender: 'patient', text: '14h00' },
